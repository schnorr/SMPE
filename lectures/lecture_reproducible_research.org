...
#+TAGS: noexport(n)
#+LaTeX_CLASS: beamer
#+LaTeX_CLASS_OPTIONS: [9pt,xcolor=dvipsnames,presentation]
...
#+LATEX_HEADER:         \definecolor{Moccasin}{rgb}{1,0.894,0.71} % Example RGB values for Moccasin
...
*** Geoffray Chang's incorrect protein structures                :noexport:
#+BEGIN_EXPORT latex
  \begin{columns}
...
*** A Reproducibility Crisis? What are the Consequences ?        :noexport:
...
*** Well... Stronger and Stronger Consequences                   :noexport:
- A recent scandal ::
...
- \normalsize Scientific fraud is bad but let's be careful :: \footnotesize
     ...
     # with h-index/]]
*** Is Fraud a new phenomenon?                                   :noexport:
#+BEGIN_CENTER
...
_Main benefit:_
  ...
  - Our research becomes *sound*, *deeper*, *auditable*, *more visible*,
    *reusable*
*** Webinars: Learning by Doing                                  :noexport:
