...
#+DATE:  March 2026\hfill \mylogo\vspace{-1.3cm}
#+LANGUAGE: en
...
#+LATEX_HEADER: \setbeamercolor{whitebg}{bg=white}
#+BEGIN_EXPORT latex
...
#+END_EXPORT
:end:
* Motivation and Introduction                                      :noexport:
...
\only<+->{
  ...
  \vspace{-7.2cm}
  \begin{center}
      \begin{beamercolorbox}[wd=\linewidth,center,sep=5pt]{whitebg}
        \includegraphics<+->[height=2cm]{images/logo/Jupyter_logo.png}
        \includegraphics<+->[height=2cm]{images/logo/OrgMode_logo.png}
        \includegraphics<+->[height=2cm]{images/logo/RStudio_logo.png}
      \end{beamercolorbox}
  \end{center}
\end{overlayarea}
}
...
\vspace{-2em}
\begin{overlayarea}{\linewidth}{0cm}
\hspace{2cm}\includegraphics[height=4cm]{images/iceberg.jpg}
\end{overlayarea}
#+END_EXPORT
...
- [[https://www.fun-mooc.fr/en/courses/reproducible-research-ii-practices-and-tools-for-managing-comput/][\bf A *new "Advanced RR" MOOC*]] \bgroup\small(1st edition 2024)\egroup
  - \footnotesize Managing research data (HDF5, archiving)
  - \footnotesize Software environment control (Docker, Guix)
...
- Mentalities are evolving :: people care, make stuff available, errors
     are found and fixed
...
#+END_CENTER
 ...
 - My [[https://www.inf.ufrgs.br/~schnorr/students][laboratory students]] that have understood the importance
...
:BEAMER_col: 0.7
:END:
\alert{MOOC} [[https://www.fun-mooc.fr/en/courses/reproducible-research-ii-practices-and-tools-for-managing-comput/][Reproducible Research II: Practices and tools for managing
computations and data]], Learning Lab Inria
- Konrad Hinsen, Arnaud Legrand, Christophe Pouzat
...
#+LaTeX: \null\vspace{-0.8cm}\includegraphics[width=.9\linewidth,valign=b]{images/mooc_rr2.png}
...
# eval: (setq org-latex-minted-options '(("style" "colorful") ("bgcolor" "Moccasin") ("frame" "lines") ("linenos" "false") ("fontsize" "\\footnotesize")))
