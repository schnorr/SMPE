...
#+LATEX_HEADER: \def\logoInstitutions{\includegraphics[height=.9cm]{./images/INF-UFRGS.png}\quad\includegraphics[height=.9cm]{./images/UFRGS.png}\vspace{-.7cm}}
...
Thanks to these people to kindly making this material available.
...
#+end_center
Celine, Cyril, Arnaud, and Jean-Marc 
...
\vspace{.5cm}
#+latex: \hbox{\hspace{-1cm}\includegraphics[width=1.19\linewidth]{images/SMPE_overview-no-schedule.pdf}}
...
- [[https://software-carpentry.org/][Software Carpentry]], [[https://book.the-turing-way.org/][The Turing Way]], ...
...
:BEAMER_env: ignoreheading
:END:
The 2nd *MOOC "Advanced RR"* has been released in +2021+ 2024
  - \footnotesize Managing data
  - \footnotesize Software environment control
  - \footnotesize Scientific workflow
\vspace{-.7cm}
