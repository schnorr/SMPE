...
#+Author: Lucas Mello Schnorr (with Arnaud Legrand)\medskip\newline\logoInstitutions
...
#+LATEX_HEADER: \def\logoInstitutions{\includegraphics[height=.7cm]{./images/ufrgs.png}\quad\includegraphics[height=.7cm]{./images/Logo-UGA2020.pdf}\quad\includegraphics[height=.7cm]{./images/Logo-CNRS.pdf}\quad\includegraphics[height=.7cm]{./images/Logo-Inria.pdf}\vspace{-.7cm}}
